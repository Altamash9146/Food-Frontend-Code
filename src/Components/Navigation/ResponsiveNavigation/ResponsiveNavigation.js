...
const ResponsiveNavigation = () => {
  ...
  const [handleHam, setHandleHam] = useState(true)
  ...
  const [arrowStates, setArrowStates] = useState(Array(7).fill('rotate(180deg)'));
  ...
  const handlearrow = (index) => {
    ...
    newArrowStates[index] = newArrowStates[index] === 'rotate(180deg)' ? 'rotate(0deg)' : 'rotate(180deg)';
...
const handleProfile = ()=>{
  ...
  return (
   ...
   <span className='heading' onClick={handleNav}>
  Food
...
{handleHam && <span className='hamburger-icon'>
<svg  
...
{ showMainNav &&  
          ...
          <div className='nav-main-panel' style={{backgroundColor:'black'}}>
    ...
    <div
        className='nav-list-item_'
      >
     <div  
     className={`nav-list-item_ ${isActive ? 'active' : ''}`}
     onClick={handleItemClick}
     > 
     Recipes
     </div> 
     <div className='arrow'>
     <FontAwesomeIcon icon={faAngleUp} style={{ transform: arrowStates[0] }}
  ...
  {showRecipe && 
   <>
   <ul className='dropdown' style={{ listStyleType: 'none' }} onClick={hideNav}>
...
<div className='border1'></div>
      ...
      <span className='nav-list-item_' >
            ...
            <FontAwesomeIcon
          icon={faAngleUp}
          style={{ transform: arrowStates[5] }}
          onClick={() => handlearrow(5)}
        />
            </span>
          </span>
...
<div className='border1'></div>
        ...
        <li className='nav-list-item'
         ...
         <span className='nav-list-item_' >
          ...
          <FontAwesomeIcon
          icon={faAngleUp}
          style={{ transform: arrowStates[6] }}
          onClick={() => handlearrow(6)}
        />
            </span>
          </span>
